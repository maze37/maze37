...
### 📌 Последние проекты и опыт

**Maestro (2025 - н.в.)**
*   Спроектировал доменную модель по принципам DDD (агрегаты, Value Objects) с защитой бизнес-инвариантов.
*   Реализовал REST API в рамках Clean Architecture.
*   Настроил gRPC взаимодействие между микросервисами и разработал SharedKernel (Result Pattern, общие контракты).
